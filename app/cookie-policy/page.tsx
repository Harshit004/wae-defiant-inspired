        ...
        <div className="flex flex-col lg:flex-row w-full">
          ...
          <div className="flex-shrink-0 flex flex-col font-['Manrope'] text-[12px] lg:text-[14px] text-[#AEAEAE] leading-[120%] lg:leading-[160%] w-full lg:w-[70%] lg:pl-[3.33vw]">
            ...
            <div id="what-are-cookies" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">1. What Are Cookies?</h2>
              ...
              <h3 id="why-we-use" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Why We Use Cookies</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="types-of-cookies" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">2. Types of Cookies We Use</h2>

              <h3 id="strictly-necessary" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Strictly Necessary Cookies</h3>
              ...
              <h3 id="performance" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Performance & Analytics Cookies</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="functional" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Functional Cookies</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="marketing" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Marketing & Targeting Cookies</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="our-inventory" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">3. Our Cookie Inventory</h2>

              <h3 id="first-party" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">First-Party Cookies (set directly by WAE)</h3>

              <div className="mb-[28px] lg:mb-[40px] space-y-[24px] ml-[35px] lg:ml-0">
                <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-[#AEAEAE]">
              ...
              <h3 id="third-party" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Third-Party Cookies</h3>

              <div className="mb-[40px] space-y-[24px] ml-[35px] lg:ml-0">
                <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-[#AEAEAE]">
                  Third Party<br />
            ...
            <div id="choices" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">4. Your Cookie Choices</h2>

              <h3 id="consent-banner" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Cookie Consent Banner</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="browser-controls" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Browser-Level Controls</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="opt-out-links" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Third-Party Opt-Out Links</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="impact" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">5. Impact of Disabling Cookies</h2>
            ...
            <div id="updates" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">6. Policy Updates</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[40px]">
            ...
            {/* Section 7 */}
            <div id="contact">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">7. Contact Us</h2>
