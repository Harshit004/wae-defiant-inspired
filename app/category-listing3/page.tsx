"use client"; // This component needs to be client-side to use hooks like useState and useSearchParams
...
// We will wrap the content that uses client-side hooks in <Suspense>.
const HomeContent: FC = () => {
  ...
  return (
    <main>
      ...
      {/* This section is outside the Suspense boundary as it doesn't directly depend on searchParams */}
      <section
...
// Main page component that includes the Suspense boundary
const Home: FC = () => {
