  ...
  const featuresData = [
    {
      ...
      subtext: "Wall-mounted drinking water dispenser and fountain.",
    },
    {
      headline: "Optional Upgrades",
      subtext: "Swap the washer and dustbin for a built-in RO unit, ensuring purified water on demand",
    },
    {
      headline: "Material & Construction",
      subtext: "Durable stainless steel 304 with galvanized iron for long-lasting performance.",
    },
    {
      headline: "Customization",
      subtext: "The backend unit is fully customizable to any space or design requirements.",
    },
    {
        headline: "Operation",
        subtext: "Convenient push-tap system for direct drinking (optional swan-neck taps available).",
    },
  ];
