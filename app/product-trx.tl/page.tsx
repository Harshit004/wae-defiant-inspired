    ...
    <main>
      ...
      <section className="max-w-full px-4 md:px-[8.75rem] py-10 md:py-[6.25rem] flex flex-col md:flex-row items-center justify-center gap-6">
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/95dc8d17-0a8d-42ff-4e56-079a56ff6300/public"
            alt="Specification 1"
        ...
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/4098bac6-416c-4d6b-16cf-ad670e50fc00/public"
            alt="Specification 2"
