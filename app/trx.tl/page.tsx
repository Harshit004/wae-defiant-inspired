...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/0a63f294-a33c-470e-8aba-f6bef589a600/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/5a89b2db-4c37-4e75-40cc-0d5afa2fac00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/e0460e14-5904-4c18-9dc4-1cf913d7da00/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Touchless Operation",
      subtext: "Sensor-activated taps with auto shut-o for a hygienic, hands-free experience.",
    },
    {
        headline: "Real-Time OLED Display",
        subtext: "Sharp display for precise option selection and temperature view.",
      },
      {
        headline: "American Disabilities Act",
        subtext: "Designed to comply with ADA accessibility guidelines. Ideal for schools & public utilities.",
      },
      {
      ...
      {
        headline: "Braille & Color Blind Friendly",
        subtext: "Features Braille and high- contrast colors for easy, inclusive use.",
      },
      {
        headline: "Built to Last",
        subtext: "Premium 100% metal construct with SS-304 stainless steel tank combining sustainability, long term value and zero to landfill.",
      },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "Faucet", subtext2: "MOSES" },
    { subtext1: "UTC Variant", heading: "1000ml", subtext2: "Hydropac Classic" },
    { subtext1: "Pressure", heading: "15-75 PSI", subtext2: "PSI" },
    { subtext1: "Height of spout", heading: "248 mm", subtext2: "With Riser" },
    { subtext1: "Tank Volume", heading: "10 L", subtext2: "Cold and Hot" },
  ];
        ...
        <div className="mt-8 md:mt-0 md:w-[37.7%] space-y-5">
            <div className="shrink-0 lg:flex-1 xl:w-[500px]">
                ...
                <div className="flex flex-col items-center justify-center gap-3">
                    ...
                    <h6 className="text-3">Chilled</h6>
                </div>
                <div className="flex flex-col items-center justify-center gap-3">
                    ...
                    <h6 className="text-3">Ambient</h6>
                </div>
                </div>
                <div className="mb-4 text-sm uppercase xl:mb-6 xl:max-w-[90%]">
                Drinking Water Faucet System
                </div>
                <ul className="">
