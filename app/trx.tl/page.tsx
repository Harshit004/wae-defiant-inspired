...
const Home: FC = () => {
  ...
  const featuresData = [
    ...
    },
    {
      ...
      subtext: "Low power consumption for cost-effective, sustainable performance.",
    },
    {
      headline: "Sleek & Compact",
      subtext: "Stylish, slim faucets that fit effortlessly into any indoor commercial space.",
    },
    {
      headline: "Easy Maintenance",
      subtext: "Quick installation and minimal upkeep for hassle-free operation.",
    },
    {
        headline: "Premium Build",
        subtext: "High-quality steel ensure durability and a modern aesthetic.",
    },
  ];
