...
import { ChevronLeft, Trash2, Plus, Save, ShieldAlert } from "lucide-react"
...
export default function NewProductPage() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>, type: "brochure" | "datasheet") => {
    ...
    try {
      ...
      setShowStorageFullModal(true) // Treat general network/API failures during upload as potential storage limits
    } finally {
      setUploading(false)
    }
  }
