...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/68c42af9-cb08-4755-4b76-b31697ee9500/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/125ecf0e-cdbd-428b-d234-f4bd1f7e4300/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/f1ad952b-5360-4a2d-e17e-13ad12147a00/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Touch free Operation",
      subtext: "Enjoy sensor-based, hygienic water dispensing that's quick, easy, and completely touchless.",
    },
    {
      headline: "Clean Flow, Minimal Splash",
      subtext: "Engineered for a smooth, laminar ow that minimizes spillage, complemented by an efficient drainage system.",
    },
    {
      headline: "LED UV-C Technology",
      subtext: "Advanced UV-C technology deactivates bacteria, viruses, and other pathogens, delivering water that's 99.99% pure.",
    },
    {
      headline: "Effortless Integration",
      subtext: "Easily connects with carbonated beverage dispensers and coffee/tea vending machines, offering a versatile hydration solution.",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "CT", subtext2: "ENKI 25/50" },
