...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/9a539ab1-e7f5-48ea-dff3-0c8071dcf300/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/25531713-c7e1-40c9-eb1b-44c3c9127400/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/a814e21b-b816-4241-14e5-2fb4e5bf4f00/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      ...
      subtext: "Rugged stainless-steel construction ensures durability and zero landll impact.",
    },
    {
      headline: "Seamless Integration",
      subtext: "Effortlessly pairs with carbonated drink dispensers and coffee/tea machines.",
    },
    {
      headline: "Generous Drainage",
      subtext: "Large drip tray captures spills, reducing water waste and simplifying cleanup.",
    },
    {
      headline: "Energy Efficient",
      subtext: "Space-saving size ts neatly into any environment, from home counters to commercial settings.",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "FS", subtext2: "AENON 36, 45,75" },
