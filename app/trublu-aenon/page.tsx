...
const Home: FC = () => {
  ...
  const featuresData = [
    ...
    },
    {
      ...
      subtext: "Premium 100% metal construct with SS-304 stainless steel tank combining sustainability and long term value. Full SS 304 version available.",
    },
    {
    ...
    },
    {
        ...
        subtext: "Certified Green 2 LPM-water flow",
    },
  ];
        ...
        <div className="mt-8 md:mt-0 md:w-[37.7%] space-y-5">
            <div className="shrink-0 lg:flex-1 xl:w-[500px]">
                ...
                <li className="mb-3 flex items-center gap-3 text-[12px] uppercase last:mb-0 ">
                    <div className="w-2 h-2 bg-black rounded-full"></div>
                    All Metal Construct: 100% Recycleable.
                </li>
                <li className="mb-3 flex items-center gap-3 text-[12px] uppercase last:mb-0 ">
                    <div className="w-2 h-2 bg-black rounded-full"></div>
                    Plumbed-in.
                ...
                <li className="mb-3 flex items-center gap-3 text-[12px] uppercase last:mb-0 ">
                    <div className="w-2 h-2 bg-black rounded-full"></div>
                    Purication: UF/RO Optional
                </li>
                <li className="mb-3 flex items-center gap-3 text-[12px] uppercase last:mb-0 ">
                    <div className="w-2 h-2 bg-black rounded-full"></div>
                    Intank LED UV-C : 24x7 - 99.99% Safe: Clean Water
                </li>
