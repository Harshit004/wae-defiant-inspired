...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/972917c4-f986-4a07-11e3-4f5ad123cb00/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/41448980-c47f-4212-9bca-68bfd7c3db00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/11983264-8f58-4311-ec84-225eacf9c000/public", // Carousel image 2
  ];
  ...
  const specificationsData = [
    { subtext1: "Variant", heading: "FS", subtext2: "AQUA" },
    ...
    <main>
      ...
      <section className="mx-[9.72%] mb-[9.72%] flex items-start justify-between">
        ...
        <div className="ml-[8.33%] flex flex-col justify-start">
          ...
          >
            PUBLIC UTILITY SYSTEMS - PUS Series
          </h3>
          <h2
            style={{
              fontFamily: "'Inter Tight', sans-serif",
