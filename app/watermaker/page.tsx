...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/13d0a907-1c95-4c88-fccc-fbc499c75100/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/fc19edb8-3d0e-475f-7a9c-fad84faa3a00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/e5a12692-239e-45be-fff0-42d2ba8d5100/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Robust construct",
      subtext: "Heavy duty RO system designed for industrial applications",
    },
    {
      headline: "Anti-bacterial",
      subtext: "Provides protection against bacteria, mould & fungi",
    },
    {
      headline: "Pre-engineered & Pre-assembled",
      subtext: "A pre-assembled factory tested units to reduce installation & set up time",
    },
    {
      headline: "Application",
      subtext: "Commercial kitchens, pantries, washing units & hospitality sector",
    },
    {
        headline: "5 - stage purification",
        subtext: "Ensures pure water from any raw water source",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "FS", subtext2: "WATERMAKER" },
    { subtext1: "Storage Capacity", heading: "150 - 250", subtext2: "Liters" },
    { subtext1: "Water Filling Speed", heading: "10 liters", subtext2: "Per Minute" },
    { subtext1: "Shipping Weigh", heading: "172 / 180", subtext2: "Kilograms" },
      ...
      <section className="mx-[9.72%] mb-[9.72%] flex md:justify-between items-start">
        ...
        <div className="mt-8 md:mt-0 md:w-[37.7%] space-y-5">
            <div className="shrink-0 lg:flex-1 xl:w-[500px]">
                ...
                <div className="mb-4 text-[12px] uppercase xl:mb-6 xl:max-w-[90%]">
