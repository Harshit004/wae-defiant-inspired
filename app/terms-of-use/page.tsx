        ...
        <div className="flex flex-col lg:flex-row w-full">
          ...
          <div className="flex-shrink-0 flex flex-col font-['Manrope'] text-[12px] lg:text-[14px] text-[#AEAEAE] leading-[120%] lg:leading-[160%] w-full lg:w-[70%] lg:pl-[3.33vw]">
            ...
            <div id="acceptance" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">1. Acceptance of Terms</h2>
              ...
              <h3 id="amendments" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Amendments & Updates</h3>
            ...
            <div id="permitted" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">2. Permitted Use of This Website</h2>

              <h3 id="authorised" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Authorised Access</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="prohibited" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Prohibited Conduct</h3>
              <div className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="intellectual" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">3. Intellectual Property Rights</h2>

              <h3 id="wae-content" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">WAE Content & Trademarks</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="licence" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Licence Restrictions</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="product" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">4. Product Information & Disclaimers</h2>

              <h3 id="specification" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Specification Accuracy</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="pricing" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Pricing & Availability</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="third-party" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">5. Third-Party Links & Content</h2>
            ...
            <div id="limitation" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">6. Limitation of Liability</h2>

              <h3 id="exclusion" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Exclusion of Warranties</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="cap" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Cap on Liability</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="governing" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">7. Governing Law & Jurisdiction</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[40px]">
            ...
            {/* Section 8 */}
            <div id="contact">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">8. Contact for Legal Enquiries</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE]">
