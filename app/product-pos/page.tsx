    ...
    <main>
      ...
      <section className="max-w-full px-4 md:px-[8.75rem] py-10 md:py-[6.25rem] flex flex-col md:flex-row items-center justify-center gap-6">
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/c3c03ee0-e254-4d82-16d0-ae2163082200/public"
            alt="Specification 1"
        ...
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/73ecb9eb-2490-4e67-5742-ea6701073800/public"
            alt="Specification 2"
