...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/9db14c02-30db-4131-3b6d-7c5b2fa3fb00/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/c274a381-1fe3-48ce-37e1-296ff4719900/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/5fcb76d0-46a1-4f0e-37f0-a1b53c6b3600/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Heavy-Duty Build",
      subtext: "High-quality SS-304 stainless steel with a vandal-resistant boom plate for superior durability.",
    },
    {
      headline: "Optional Purification",
      subtext: "Customizable back-end purification available.",
    },
    {
      headline: "Efficient Drainage",
      subtext: "Designed with a proper drainage system to eliminate standing water.",
    },
    {
      headline: "Easy Installation",
      subtext: "Quick wall-hanging or wall-mount setup.",
    },
    {
        headline: "Bubbler Heads",
        subtext: "Polished single or dual bubble heads with a convenient basin.",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "Fountain", subtext2: "PLUSULTRA" },
    { subtext1: "UTC Variant", heading: "1000ml", subtext2: "Hydropac Classic TL" },
    { subtext1: "Power Consumption", heading: "94 W", subtext2: "Watts" },
    { subtext1: "Water Dispenser", heading: "3l to 10l", subtext2: "Per Minute" },
    ...
    <main>
      ...
      <section className="mx-[9.72%] mb-[9.72%] flex items-start justify-between">
        ...
        <div className="ml-[8.33%] flex flex-col justify-start">
          ...
          >
            WATER COOLER & FOUNTAINS - ZVR Series
          </h3>
          <h2
            style={{
              fontFamily: "'Inter Tight', sans-serif",
        ...
        <div className="mt-8 md:mt-0 md:w-[37.7%] space-y-5">
            <div className="shrink-0 lg:flex-1 xl:w-[500px]">
                ...
                <li className="mb-3 flex items-center gap-3 text-[12px] uppercase last:mb-0 ">
                    ...
                    Hygienic, touchless operation with sensor activation.
                </li>
                <li className="mb-3 flex items-center gap-3 text-[12px] uppercase last:mb-0 ">
                    <div className="w-2 h-2 bg-black rounded-full"></div>
                    Durable SS-304 modular body ensures long-lasting performance.
                </li>
                <li className="flex items-center gap-3 text-[12px] uppercase last:mb-0 ">
                    <div className="w-2 h-2 bg-black rounded-full"></div>
                    Quick-fill water dispenser with single spout/bubbler, reducing plastic use.
                </li>
                </ul>
            </div>
            </div>
