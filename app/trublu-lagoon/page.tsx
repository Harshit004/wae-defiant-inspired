...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/70fa9ba1-f0e8-490b-fe4a-4ca531a63700/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/89fe9111-df3e-44fd-146b-913905054100/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/f6efba25-b43c-449d-d14d-a785f6e61b00/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Premium Storage Tank",
      subtext: "High-quality Stainless Steel (SS-304) for corrosion resistance and no bad odors or microbial growth.",
    },
    {
      headline: "Efficient Drainage System",
      subtext: "Dishwasher-safe drip tray minimizes spillage and simplifies cleaning.",
    },
    {
      headline: "Safe Internal Tubings",
      subtext: "Lead-free, bacteria-resistant, and corrosion-resistant for pure water.",
    },
    {
      headline: "Seamless Integration",
      subtext: "Connects effortlessly with carbonated beverage dispensers and coffee/tea machines",
    },
    {
        headline: "Rapid Touchless Dispensing",
        subtext: "Fast, touchless access to chilled and hot water for enhanced convenience.",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "FS", subtext2: "LAGOON" },
    ...
    <main>
      ...
      <section className="mx-[9.72%] mb-[9.72%] flex items-start justify-between">
        ...
        <div className="ml-[8.33%] flex flex-col justify-start">
          ...
          >
            WATER DISPENSER (W/O RO) - TRUBLU Series
          </h3>
          <h2
            style={{
              fontFamily: "'Inter Tight', sans-serif",
