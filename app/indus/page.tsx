...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/02dfe0c0-93c7-4086-6508-6ea0bc1b2a00/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/27e09afa-2851-4872-bb0a-29b397568000/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/1a765a6d-b8e2-457a-150d-efcbe1fffa00/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      ...
      subtext: "Advance IR sensors and touch panels for a superior and flexible hydration experience.",
    },
    {
