...
const Home: FC = () => {
  ...
  const featuresData = [
    {
      headline: "Touchless & TOUCH BASED OPERATION",
      subtext: "Equipped with three IR sensors and touch panels for a superior and flexible hydration experience.",
    },
    {
      headline: "Durable Construction",
      subtext: "Made from high-quality stainless steel for enduring performance and reliability.",
    },
    {
      headline: "Real-Time OLED Display",
      subtext: "Clearly shows the water temperature for accurate and convenient selection.",
    },
    {
      headline: "Spill-Proof Drip Tray",
      subtext: "Includes a spill-proof drip tray to maintain a clean and dry area.",
    },
    {
        headline: "Adjustable Flow Control",
        subtext: "Tailor the water ow to your preference, from quick sips to lling larger containers.",
    },
  ];
