...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/afee7058-847e-4a58-55d9-ede5da5c6800/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/a8f5a00e-0285-460b-f009-fa5a3a4d8c00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/07be5d57-d7fd-444f-52f5-6062969b5200/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Robust & Durable Build",
      subtext: "Constructed with premium Stainless Steel (SS-304) and corrosion-resistant GI, ensuring food-grade safety and long-lasting durability.",
    },
    {
      headline: "Touchless Dispensing",
      subtext: "Experience the convenience of sensor-based technology for hygienic, hands-free water dispensing.",
    },
    {
      headline: "Advanced LED UV-C Technology",
      subtext: "Effectively neutralizes bacteria, viruses, and other pathogens, delivering water that's purified up to 99.99%.",
    },
    {
      headline: "Real-Time Monitoring",
      subtext: "Stay informed with an intuitive IoT display powered by CIRCLE OF BLUE, showcasing key data and performance metrics in real-time.",
    },
    {
  ...
  const specificationsData = [
    { subtext1: "Variant", heading: "FS", subtext2: "REVA 50/100" },
