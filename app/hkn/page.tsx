...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/2e897fea-6219-4096-1989-ac1855719800/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/76de532d-a762-4789-d348-ffa6ddab9700/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/2e897fea-6219-4096-1989-ac1855719800/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Manual Operation",
      subtext: "Pure, sparkling water in chilled, hot, and ambient temperatures",
    },
    {
      headline: "User-Friendly Controls",
      subtext: "Easy-to-use knob for selecting and adjusting the water flow.",
    },
    {
      headline: "Convenient & Clean",
      subtext: "Drip-free and corrosion- resistant trays to reduce spillage and waste.",
    },
    {
      headline: "Sleek & Compact Design",
      subtext: "Slim, stylish faucets perfect for any indoor commercial space.",
    },
    {
        headline: "Corrosion- Resistant & Food-Grade",
        subtext: "SS-304 ensures pure, corrosion-free water 24/7.",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "Faucet", subtext2: "HKN" },
    { subtext1: "UTC Variant", heading: "1000ml", subtext2: "Hydropac Classic TL" },
    { subtext1: "Pressure", heading: "15-75 PSI", subtext2: "PSI" },
    { subtext1: "Height of spout", heading: "285 mm", subtext2: "With Riser" },
