...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/6f18f17d-9a94-494d-c816-0832fd9d2000/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/6f18f17d-9a94-494d-c816-0832fd9d2000/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/6f18f17d-9a94-494d-c816-0832fd9d2000/public", // Carousel image 2
  ];
    ...
    <main>
      ...
      <section className="max-w-full px-4 md:px-[8.75rem] py-10 md:py-[6.25rem] flex flex-col md:flex-row items-center justify-center gap-6">
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/db541b5e-91b9-491f-ee54-9172216abf00/public"
            alt="Specification 1"
        ...
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/3ec4cec4-ba9a-4b63-9a5e-ccad86325200/public"
            alt="Specification 2"
