...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/79ce8da9-daaa-4bad-c80a-5a5f47af3c00/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/4eb27063-2310-4888-4f1c-9f4b02493d00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/c96d8adb-e99f-4181-f45f-1bbd40918c00/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Powerful LED Powerful LED Sterilization",
    ...
    <main>
          ...
          <div className="mt-4 md:mt-0 w-full md:w-[37.7%] space-y-5 flex flex-col items-center text-center md:items-start md:text-left">
            <div className="shrink-0 lg:flex-1 xl:w-[500px]">
                ...
                <div className="flex flex-col items-center justify-center gap-3">
                    <svg width={26.833396911621094} height={26.832416534423828} viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ fill: '#FF470D' }}>
                ...
                <div className="flex flex-col items-center justify-center gap-3">
                    <svg width={26.833396911621094} height={26.832416534423828} viewBox="0 0 25 27" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ fill: 'blue' }}>
                ...
                <div className="flex flex-col items-center justify-center gap-3">
                    <svg width={26.833396911621094} height={26.832416534423828} viewBox="0 0 22 27" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ fill: '#FFBC3A' }}>
      ...
      <section className="max-w-full px-4 md:px-[8.75rem] py-10 md:py-[6.25rem] flex flex-col md:flex-row items-center justify-center gap-6">
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/5f3efd16-3bbd-4368-aba6-9ee79fa17200/public"
            alt="Specification 1"
        ...
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/38e2133e-85df-463e-e997-dd7f21c94d00/public"
            alt="Specification 2"
