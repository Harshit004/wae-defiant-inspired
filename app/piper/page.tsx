  ...
  const featuresData = [
    {
      ...
      subtext: "Triple-coated galvanized iron with a protective powder finish.",
    },
    {
      headline: "Pure & Safe Storage",
      subtext: "Stainless steel tank guarantees 99.99% pure, contaminant-free water.",
    },
    {
      headline: "Extended Durability",
      subtext: "Optional anti-rust treatment and stainless steel 304 overhead protection.",
    },
    {
      headline: "Longer Lifespan",
      subtext: "Customizable design, easy maintenance, and energy-efficient operation.",
    },
    {
        headline: "High Capacity",
        subtext: "Designed to handle heavy water demand in busy environments.",
    },
  ];
