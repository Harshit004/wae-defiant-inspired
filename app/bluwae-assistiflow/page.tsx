  ...
  const featuresData = [
    {
      ...
      subtext: "Thoughtfully engineered to be accessible for seniors, kids, and those with special needs, making hydration easy for all.",
    },
    {
    ...
    },
    {
      ...
      subtext: "Steel (SS-304) and corrosion-resistant Galvanized Iron (GI), ensuring durability and safety with food-grade materials.",
    },
    {
      headline: "Advanced Purication",
      subtext: "LED UV-C technology neutralizes up to 99.99% of bacteria, viruses, and other pathogens, ensuring every sip is pure.",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "FS", subtext2: "ASSISTIFLOW" },
