...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/ad1ea063-3e9d-494e-262b-9e0dfec7e500/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/c0002234-c76a-48ba-6b12-308e26b39f00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/b6fd26a4-7fe7-4df7-b4b7-b58aae572200/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Sensor-Based Operation",
      subtext: "Touchless and hygienic dispensing ensures a seamless and safe user experience.",
    },
    {
      headline: "Effortless Drainage",
      subtext: "Equipped with a generous drip tray to efficiently collect accidental spillage, maintaining cleanliness.",
    },
    {
      headline: "LED UV-C Technology",
      subtext: "Incorporates advanced UV-C technology that reduces the risk of bacteria, viruses, and other pathogens at the point of dispensing, ensuring water purity up to 99.99%.",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "FS", subtext2: "ROM 50/100" },
