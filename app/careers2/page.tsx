      ...
      <section className="w-full px-[9.722222%] max-w-[1440px] mx-auto">
        ...
        <div className="mt-[140px]">
          <h2 style={{
            ...
            letterSpacing: 0,
            verticalAlign: 'middle',
          }} className="mb-5">Explore Roles</h2>
          <p style={{
            fontFamily: "'Inter Tight', sans-serif",
            fontWeight: 500,
            fontStyle: "Medium",
            ...
            letterSpacing: 0,
            verticalAlign: 'middle',
          }} className="mb-[100px]">Choose the path where your passion meets purpose.</p>
          <div className="flex flex-col md:flex-row gap-8 md:gap-0 w-full justify-between">
            {/* Column 1 */}
            <div className="flex-1 flex flex-col" style={{maxWidth: '27%'}}>
              <h3 style={{
                fontFamily: "'Inter Tight', sans-serif",
                fontWeight: 700,
                fontStyle: "Bold",
                ...
                verticalAlign: 'middle',
                textTransform: 'uppercase',
              }} className="mb-8">ENGINEERING & PROJECTS</h3>
              <p style={{
                fontFamily: "'Inter Tight', sans-serif",
                fontWeight: 400,
                fontStyle: "Regular",
                ...
                letterSpacing: 0,
                verticalAlign: 'middle',
              }} className="mb-5">Design and implement intelligent water systems that power communities and industries.</p>
              <a href="#" style={{
                fontFamily: "'Inter Tight', sans-serif",
                fontWeight: 500,
                fontStyle: "Medium",
              ...
              }}>Explore Engineering & Projects &rarr;</a>
            </div>
            {/* Column 2 */}
            <div className="flex-1 flex flex-col" style={{maxWidth: '27%'}}>
              <h3 style={{
                ...
                verticalAlign: 'middle',
                textTransform: 'uppercase',
              }} className="mb-8">CORPORATE & STRATEGY</h3>
              <p style={{
                fontFamily: "'Inter Tight', sans-serif",
                fontWeight: 400,
                fontStyle: "Regular",
                ...
                letterSpacing: 0,
                verticalAlign: 'middle',
              }} className="mb-5">Drive the vision behind our growth. From finance to HR, shape the way WAE works.</p>
              <a href="#" style={{
                fontFamily: "'Inter Tight', sans-serif",
                fontWeight: 500,
                fontStyle: "Medium",
                ...
                textDecorationStyle: 'solid',
                textUnderlineOffset: 4,
              }}>Explore Corporate & Strategy &rarr;</a>
            </div>
            {/* Column 3 */}
            <div className="flex-1 flex flex-col" style={{maxWidth: '27%'}}>
              <h3 style={{
                ...
                verticalAlign: 'middle',
                textTransform: 'uppercase',
              }} className="mb-8">SUSTAINABILITY & R&D</h3>
              <p style={{
                fontFamily: "'Inter Tight', sans-serif",
                fontWeight: 400,
                fontStyle: "Regular",
                ...
                letterSpacing: 0,
                verticalAlign: 'middle',
              }} className="mb-5">Innovate the future of hydration through research, science, and environmental breakthroughs.</p>
              <a href="#" style={{
                fontFamily: "'Inter Tight', sans-serif",
                fontWeight: 500,
                fontStyle: "Medium",
                ...
                textDecorationStyle: 'solid',
                textUnderlineOffset: 4,
              }}>Explore Sustainability & R&D &rarr;</a>
        </div>
      </div>
      </div>
    </section>
