...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/0b994225-97de-4679-daf1-8e5008e73500/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/a1a596c2-4a97-4da4-72a4-577ccb20a900/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/3b24c06b-1752-47a0-4499-be61a2497800/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "TOUCH BASED OPERATION",
      subtext: "Enjoy 24*7 pure water with just a touch, providing an exceptional hydration experience.",
    },
      {
  ...
  const specificationsData = [
    { subtext1: "Variant", heading: "Faucet", subtext2: "AQUA 100/200" },
    { subtext1: "UTC Variant", heading: "1000ml", subtext2: "Hydropac Classic TL" },
    { subtext1: "Pressure", heading: "15-75 PSI", subtext2: "PSI" },
    { subtext1: "Height of spout", heading: "310 mm", subtext2: "With Riser" },
    { subtext1: "Height of spout", heading: "215 mm", subtext2: "Without Riser" },
  ];
