...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/3b80e936-57ba-457d-a11b-85833225c200/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/8a7824d7-7f82-49fd-10cf-aaae8610e100/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/f2a3cb85-9bb6-42ce-54c5-35f6bd266000/public", // Carousel image 2
  ];
  ...
  const specificationsData = [
    { subtext1: "Variant", heading: "TL", subtext2: "ALFA" },
    { subtext1: "Weight", heading: "48", subtext2: "Kilo Grams" },
    { subtext1: "Storage Capacity", heading: "Hot 1 | Cold 2", subtext2: "Litres (ALFA.TL.7CH)" },
    { subtext1: "Storage Capacity", heading: "Hot 1 | Cold 2 | Reserve 4", subtext2: "Litres (ALFA.TL.7CHA)" },
    { subtext1: "Dimensions", heading: "1200/400/400", subtext2: "MM" },
      ...
      <section className="mx-[9.72%] mb-[9.72%] flex md:justify-between items-start">
        ...
        <div className="mt-8 md:mt-0 md:w-[37.7%] space-y-5">
            <div className="shrink-0 lg:flex-1 xl:w-[500px]">
                ...
                <li className="flex items-center gap-3 text-[12px] uppercase last:mb-0 e">
                    <div className="w-2 h-2 bg-black rounded-full"></div>
