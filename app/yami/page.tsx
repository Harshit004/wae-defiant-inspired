...
const Home: FC = () => {
  ...
  const featuresData = [
    {
      headline: "Sleek Bubbler Head",
      subtext: "Chrome-plated brass head with a polished finish for a refined look and smooth water flow.",
    },
    {
      headline: "Efficient Drainage",
      subtext: "Efficient drainage eliminates standing water, keeping the area clean and dry.",
    },
    {
