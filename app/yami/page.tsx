...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/4617ef86-d822-4f26-a0e8-d81be539da00/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/85bdf8ae-9a9c-4e51-262c-3086fce40d00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/916a4dbf-24a7-4130-00bf-c35c5693ce00/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Sleek Bubbler Head At a glance",
      subtext: "Chrome-plated brass head with a polished nish for a rened look and smooth water flow.",
    },
    {
      headline: "Hygienic Tubing",
      subtext: "100% lead-free, anti-bacterial tubes eliminate cross-contamination risks, ensuring pure, safe water.",
    },
    {
      headline: "Splash-Free Experience",
      subtext: "Engineered for a clean, controlled ow that minimizes spillage and water waste.",
    },
    {
      headline: "Smart Drainage System",
      subtext: "Ecient drainage eliminates standing water, keeping the area clean and dry.",
    },
    {
      headline: "Fully Accessible",
      subtext: "ADA-compliant design ensures effortless use for everyone.",
    },
    {
  ...
  const specificationsData = [
    { subtext1: "Variant", heading: "Fountain", subtext2: "PENGUIN" },
    { subtext1: "UTC Variant", heading: "1000ml", subtext2: "Hydropac Classic TL" },
    { subtext1: "Power Consumption", heading: "94 W", subtext2: "W" },
