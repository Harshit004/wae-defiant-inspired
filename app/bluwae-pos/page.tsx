...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/2e1a6e7f-0b55-4344-4ff9-8dba915a3300/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/6b2da797-9d52-40d1-3323-c86ddd384c00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/8fab5f68-c2e5-4ec8-f700-cfcea83f7600/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      ...
      subtext: "Experience seamless, sensor-based water dispensing that's hygienic and completely touchless.",
    },
    {
      headline: "Smooth, Splash-Free FLOW",
      subtext: "Designed for a clean, laminar water ow that minimizes spillage, paired with an efficient drainage system.",
    },
    {
      headline: "Powerful LED UV-C Purication",
      subtext: "Eliminates bacteria, viruses, and pathogens, ensuring water is purified up to 99.99% for safe, refreshing hydration.",
    },
    {
      headline: "Versatile Integration",
      subtext: "Effortlessly integrates with carbonated beverage dispensers and coffee/tea vending machines, providing a flexible, all-in-one hydration solution.",
    },
  ];

  const specificationsData = [
    { subtext1: "Variant", heading: "FS", subtext2: "POS" },
    { subtext1: "Drip Try Capacity", heading: "950ml", subtext2: "Milli Ltires" },
