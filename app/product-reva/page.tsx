    ...
    <main>
      ...
      <section className="max-w-full px-4 md:px-[8.75rem] py-10 md:py-[6.25rem] flex flex-col md:flex-row items-center justify-center gap-6">
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/a66e37e7-ec72-4be2-2e43-c92f8812ab00/public"
            alt="Specification 1"
        ...
        <div className="w-full flex justify-center relative group">
          <img
            src="https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/30e45f93-c715-4bd2-d9ea-d9656f492f00/public"
            alt="Specification 2"
