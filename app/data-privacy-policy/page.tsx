...
const containerClass = "mx-auto w-full max-w-[1440px] px-[24px] lg:px-[7.5vw]";
...
export default function DataPrivacyPolicy() {
  return (
    <main className="relative min-h-screen bg-[#0F0F0F] text-white selection:bg-white selection:text-black overflow-x-hidden font-sans">
      ...
      <div className={`${containerClass} relative z-10 pt-[120px] lg:pt-[230px] pb-[120px]`}>
        {/* Title & Subtitle */}
        <h1 className="font-['Inter_Tight'] font-normal text-[28px] lg:text-[40px] leading-[105%] capitalize text-white mb-[12px] lg:mb-[19px]">
          Data Privacy Policy
        </h1>
        <p className="font-['Manrope'] font-normal text-[12px] leading-none text-[#AEAEAE] mb-[28px] lg:mb-[40px]">
          Effective Date: 1 January 2026 &nbsp;|&nbsp; Last Updated: April 2026
        </p>

        {/* Intro Text */}
        <div className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-[#AEAEAE] text-justify space-y-[24px] mb-[40px] lg:mb-[63px]">
          <p>
        ...
        <hr className="border-t border-[#FFFFFF33] mb-[40px] block lg:hidden" />

        {/* Two Column Layout */}
        <div className="flex flex-col lg:flex-row w-full">
          {/* Left Sidebar (Sticky) */}
          <div className="hidden lg:block border-r border-white/20 flex-shrink-0 w-[30%] pr-[6.59vw]">
          ...
          {/* Right Content Area */}
          <div className="flex-shrink-0 flex flex-col font-['Manrope'] text-[12px] lg:text-[14px] text-[#AEAEAE] leading-[120%] lg:leading-[160%] w-full lg:w-[70%] lg:pl-[3.33vw]">

            {/* Section 1 */}
            <div id="intro" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">1. Introduction & Our Commitment to Privacy</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px]">
              ...
              <h3 id="who-we-are" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Who We Are</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="scope" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Scope of This Policy</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="philosophy" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Our Data Protection Philosophy</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="personal-data" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">2. Personal Data We Collect</h2>

              <h3 id="info-directly" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Information You Provide Directly</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="info-auto" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Information Collected Automatically</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="info-third" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Information from Third Parties</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="how-we-use" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">3. How We Use Your Personal Data</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px]">
              ...
              <h3 id="biz-ops" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Business Operations & Service Delivery</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="marketing" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Marketing Communications</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="compliance" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Legal & Regulatory Compliance</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="sharing" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">4. Data Sharing & Third Parties</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px]">
              ...
              <h3 id="providers" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Service Providers & Data Processors</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="partners" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Business Partners & Channel Partners</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="disclosures" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Legal & Regulatory Disclosures</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="rights" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">5. Your Rights</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-[#AEAEAE] mb-[28px] lg:mb-[40px]">
              ...
              <h3 id="exercise" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">How to Exercise Your Rights</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="security" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">6. Data Security & Retention</h2>

              <h3 id="measures" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Technical & Organisational Security Measures</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
              ...
              <h3 id="retention" className="font-['Inter_Tight'] font-normal text-[12px] lg:text-[14px] leading-[105%] text-white mb-[12px] lg:mb-[24px] ml-[35px] lg:ml-0">Retention Periods</h3>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[28px] lg:mb-[40px] ml-[35px] lg:ml-0">
            ...
            <div id="cookies" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">7. Cookies & Tracking Technologies</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[40px]">
            ...
            <div id="transfers" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">8. International Data Transfers</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[40px]">
            ...
            <div id="updates" className="mb-[40px]">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">9. Policy Updates</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-justify text-[#AEAEAE] mb-[40px]">
            ...
            {/* Section 10 */}
            <div id="contact">
              <h2 className="font-['Manrope'] font-normal text-[16px] lg:text-[20px] leading-none text-white mb-[24px]">10. Contact Our Data Protection Team</h2>
              <p className="font-['Manrope'] font-normal text-[12px] lg:text-[14px] leading-[120%] lg:leading-normal text-[#AEAEAE] lg:mb-[40px]">
