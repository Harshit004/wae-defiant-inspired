...
const Home: FC = () => {
  ...
  const featuresData = [
    {
      headline: "Sensor Activated",
      subtext: "Touchless operation with auto shut-o for maximum hygiene.",
    },
    {
      headline: "Anti-Splash Drip Tray",
      subtext: "Smart drip tray with sensors for mess-free dispensing of hot, cold, and ambient water.",
    },
    {
      headline: "Corrosion- Resistant",
      subtext: "Stainless steel built ensures clean, durable, and corrosion-free water.",
    },
    {
    ...
    {
        headline: "Accessible Design",
        subtext: "Easy for seniors, children, and those with special needs to use comfortably.",
    },
  ];
