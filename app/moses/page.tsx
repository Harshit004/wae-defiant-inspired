...
const Home: FC = () => {
  ...
  const productImages = [
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/8440a366-f65d-40b0-7b2c-582ad7f8cc00/public", // Main image
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/47b3d27b-b65b-4e94-26d1-ac8bb35afd00/public", // Carousel image 1
    "https://imagedelivery.net/R9aLuI8McL_Ccm6jM8FkvA/0a6c1075-ac97-4c46-d1b9-42d3b6d82900/public", // Carousel image 2
  ];
  ...
  const featuresData = [
    {
      headline: "Sensor/Push Button Activated",
      subtext: "Touchless operation with auto shut-off for maximum hygiene.",
    },
    {
  ...
  const specificationsData = [
    ...
    { subtext1: "Height of spout", heading: "300 mm", subtext2: "With Riser" },
      ...
      <section className="mx-[9.72%] mb-[9.72%] flex md:justify-between items-start">
        ...
        <div className="mt-8 md:mt-0 md:w-[37.7%] space-y-5">
            <div className="shrink-0 lg:flex-1 xl:w-[500px]">
                ...
                Premium Drinking Water Faucet System
                </div>
                <ul className="">
                ...
                <li className="mb-3 flex items-center gap-3 text-[12px] uppercase last:mb-0 ">
                    <div className="w-2 h-2 bg-black rounded-full"></div>
                    Integrated with under the counter(UTC) compact Hydropac Processor.
                </li>
