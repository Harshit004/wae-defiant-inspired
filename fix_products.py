...
# Modify mobile carousel elements
...
new_mobile_carousel = new_mobile_carousel.replace('href="/portfolio" className="', 'href="/portfolio" className="h-[128.75vw] ')
