    ...
    <div className="w-full bg-black text-white flex flex-col md:flex-row justify-between items-start">
        ...
        <div className="w-full md:w-[40%] flex flex-col pt-12 md:pt-0">
            ...
            <p style={{
                ...
                Every water challenge is different. Let's find the right solution for yours.
            </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-10">
                ...
                <div className="mt-8">
                    ...
                    >
                        ...
                        <svg width="40" height="24" viewBox="0 0 40 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-transform group-hover:translate-x-2">
